...
import { InternetComputerOption } from './InternetComputerOption'
...
export default function WalletModal({
  ...
  function getOptions() {
    ...
    const internetComputerOption = <InternetComputerOption tryActivation={tryActivation} />

    return (
      <>
        {internetComputerOption}
        {injectedOption}
